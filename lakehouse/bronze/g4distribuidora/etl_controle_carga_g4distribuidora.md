...
# bronze.etl_controle_carga_g4distribuidora
...
```sql
CREATE TABLE [bronze].[etl_controle_carga_g4distribuidora] (
    ...
    CONSTRAINT [PK__etl_cont__3213E83F81962A31] PRIMARY KEY ([id])
);
```
