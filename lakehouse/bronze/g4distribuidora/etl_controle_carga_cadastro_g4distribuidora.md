...
# bronze.etl_controle_carga_cadastro_g4distribuidora
...
```sql
CREATE TABLE [bronze].[etl_controle_carga_cadastro_g4distribuidora] (
    ...
    CONSTRAINT [PK__etl_cont__3213E83FFFCD0EBB] PRIMARY KEY ([id])
);
```
