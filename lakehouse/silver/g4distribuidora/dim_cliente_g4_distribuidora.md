...
# silver.dim_cliente_g4_distribuidora
...
|---|---|---|
| fk_cliente_g4dist_grupo | sk_grupo_cliente | silver.dim_grupo_cliente_g4_distribuidora.sk_grupo_cliente |
| fk_cliente_g4dist_segmento | sk_segmento | silver.dim_ramo_atividade_g4_distribuidora.sk_ramo_atividade |

## DDL Reconstruida

```sql
CREATE TABLE [silver].[dim_cliente_g4_distribuidora] (
    ...
    CONSTRAINT [pk_cliente_g4dist] PRIMARY KEY ([sk_cliente])
);
```
