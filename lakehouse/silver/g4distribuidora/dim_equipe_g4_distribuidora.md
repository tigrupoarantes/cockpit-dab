...
# silver.dim_equipe_g4_distribuidora
...
|---|---|---|
| fk_equipe_g4dist_gerencia | sk_gerencia | silver.dim_gerencia_g4_distribuidora.sk_gerencia |
| fk_equipe_g4dist_supervisor | sk_supervisor | silver.dim_vendedor_g4_distribuidora.sk_vendedor |

## DDL Reconstruida

```sql
CREATE TABLE [silver].[dim_equipe_g4_distribuidora] (
    ...
    CONSTRAINT [pk_equipe_g4dist] PRIMARY KEY ([sk_equipe])
);
```
