...
# silver.dim_situacao_pedido_chokdistribuidora
...
```sql
CREATE TABLE [silver].[dim_situacao_pedido_chokdistribuidora] (
    [sk_situacao_pedido] int IDENTITY(1,1) NOT NULL,
    [cod_situacao_pedido] char(2) NOT NULL,
    [descricao] varchar(20) NOT NULL,
    [hash_diff] binary(32) NULL,
    CONSTRAINT [pk_situacao_pedido_chokdist] PRIMARY KEY ([sk_situacao_pedido])
);
```
