...
# silver.dim_grupo_cliente_chokdistribuidora
...
```sql
CREATE TABLE [silver].[dim_grupo_cliente_chokdistribuidora] (
    [sk_grupo_cliente] int IDENTITY(1,1) NOT NULL,
    [cod_grupo_cliente] varchar(10) NOT NULL,
    [descricao] varchar(60) NOT NULL,
    [vl_limite_credito] numeric(12,2) NULL,
    CONSTRAINT [pk_grupo_cliente_chokdist] PRIMARY KEY ([sk_grupo_cliente])
);
```
