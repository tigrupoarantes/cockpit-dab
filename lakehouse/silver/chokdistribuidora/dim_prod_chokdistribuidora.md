...
# silver.dim_prod_chokdistribuidora
...
| 15 | hash_diff | binary(32) | True | False | False | - |

## Relacionamentos

| fk | coluna | referencia |
|---|---|---|
| fk_produto_chokdist_fabric | sk_fabric | silver.dim_fabric_chokdistribuidora.sk_fabricante |
| fk_produto_chokdist_linha | sk_linha | silver.dim_linha_chokdistribuidora.sk_linha |

## DDL Reconstruida

```sql
CREATE TABLE [silver].[dim_prod_chokdistribuidora] (
    ...
    CONSTRAINT [pk_produto_chokdist] PRIMARY KEY ([sk_prod])
);
```
