...
# silver.dim_ramo_atividade_chokdistribuidora
...
```sql
CREATE TABLE [silver].[dim_ramo_atividade_chokdistribuidora] (
    [sk_ramo_atividade] int IDENTITY(1,1) NOT NULL,
    [cod_ramo_atividade] varchar(4) NOT NULL,
    [descricao] varchar(40) NOT NULL,
    [sigla] varchar(6) NULL,
    CONSTRAINT [pk_ramo_atividade_chokdist] PRIMARY KEY ([sk_ramo_atividade])
);
```
