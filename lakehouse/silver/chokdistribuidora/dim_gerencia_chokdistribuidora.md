...
# silver.dim_gerencia_chokdistribuidora
...
|---|---|---|
| fk_gerencia_chokdist_gerente | sk_gerente | silver.dim_vendedor_chokdistribuidora.sk_vendedor |

## DDL Reconstruida

```sql
CREATE TABLE [silver].[dim_gerencia_chokdistribuidora] (
    [sk_gerencia] int IDENTITY(1,1) NOT NULL,
    [sk_gerente] int NULL,
    [cod_gerencia] varchar(4) NOT NULL,
    [descricao] varchar(40) NOT NULL,
    CONSTRAINT [pk_gerencia_chokdist] PRIMARY KEY ([sk_gerencia])
);
```
